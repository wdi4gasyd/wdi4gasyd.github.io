...
// <<===========================================================================================================>>
        ...
        // Erik =====
        Erik = game.add.sprite(1400, 1450, 'Erik');
...
// <<===========================================================================================================>>
    ...
    function markSpeak (player, Mark) {
        ...
        markStyle = { font: "16px Arial", fill: "#fff", align: "center" };
        var markisms = ["\"Hi! I'm Mark.\"", "\"I like to talk about how you are feeling, how I am feeling and stuff like that.\"", "\"I have white hair in my beard. This means I'm either I'm getting old..OR..I'm becoming a Wizard!\""]
